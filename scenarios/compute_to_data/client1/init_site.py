...
def add_initial_assets(client: InternalSiteRestClient) -> None:
    output_base = DataAsset(
            'asset:party1_ns:ctd.data.output_base:party1_ns:site1', None,
            f'{ASSET_DIR}/data-asset-base.tar.gz')

    script_metadata = ComputeMetadata({
            'output0': 'asset:party1_ns:ctd.data.output_base:party1_ns:site1'})

    script = ComputeAsset(
            'asset:party1_ns:ctd.software.script1:party1_ns:site1', None,
