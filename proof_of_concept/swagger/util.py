...
def _deserialize(data: Union[Dict, List, str], klass: ClassVar) -> Any:
...
def deserialize_date(string: str) -> str:
...
def deserialize_datetime(string: str) -> str:
...
def deserialize_model(data: Union[Dict, List], klass: ClassVar) -> Any:
